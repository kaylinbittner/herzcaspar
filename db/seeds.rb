...
interest_details_list = [
  ...
  ["Action", "Adventure", "Comedy", "Crime", "Drama", "Fantasy", "Historical", "Historical Fiction", "Horror", "Mystery", "Political", "Romance", "Saga", "Satire", "Science Fiction", "Thriller", "Western", "Romantic Comedy", "Animation", "Other - Not Listed"],
